...
const Doctors = () => {
  ...
  const doctors = [
    ...
    },
    {
      ...
      location: 'Medanta Hospital, Gurugram',
      offersVirtual: true,
      bio: 'Dr. Verma specializes in preventative cardiology and clinical cardiology. He is dedicated to helping patients achieve optimal heart health.',
      languages: ['English', 'Hindi'],
      education: 'MBBS, MD (Cardiology) - BHU Varanasi',
      achievements: ['Awarded Best Young Cardiologist 2021', 'Conducted 50+ free heart checkup camps'],
      availableDays: [1, 2, 3, 4, 5]
    },
    {
      id: '12',
      ...
      imageUrl: 'https://images.unsplash.com/photo-1594824476967-48c8b964273f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80',
      ...
      offersVirtual: true,
      bio: 'Dr. Rao is an expert in clinical and cosmetic dermatology. She provides personalized skin, hair, and nail treatments.',
      languages: ['English', 'Hindi', 'Kannada'],
      education: 'MBBS, MD (Dermatology) - BMC Bangalore',
      achievements: ['Fellowship in Laser Surgery - Singapore', 'Member of Cosmetic Dermatology Society of India'],
      availableDays: [1, 3, 5]
    },
    {
      id: '13',
      ...
      offersVirtual: false,
      bio: 'Dr. Das offers comprehensive pediatric care, focusing on childhood infectious diseases, immunization, and growth monitoring.',
      languages: ['English', 'Hindi', 'Bengali'],
      education: 'MBBS, MD (Pediatrics) - IPGMER Kolkata',
      achievements: ['Gold Medalist in Pediatrics MD', 'Active researcher in childhood nutrition'],
    ...
    },
    {
      ...
      offersVirtual: true,
      bio: 'Dr. Nair specializes in managing epilepsy, migraines, neuropathies, and neurodegenerative disorders.',
      languages: ['English', 'Hindi', 'Malayalam'],
      education: 'MBBS, DM (Neurology) - NIMHANS Bangalore',
      achievements: ['Published study on migraine management in Indian context', 'Awarded NIMHANS Best Resident 2015'],
      availableDays: [2, 3, 4]
    },
    {
      id: '15',
      ...
      offersVirtual: false,
      bio: 'Dr. Gupta specializes in joint replacements, fracture management, and pediatric orthopedics.',
      languages: ['English', 'Hindi', 'Gujarati'],
      education: 'MBBS, MS (Orthopedics) - Grant Medical College, Mumbai',
      achievements: ['Completed 1000+ joint replacement surgeries', 'Faculty member at various orthopedic workshops'],
    ...
    },
    {
      ...
      offersVirtual: true,
      bio: 'Dr. Joshi is dedicated to women\'s wellness, specializing in high-risk obstetrics, laparoscopy, and adolescent gynecology.',
      languages: ['English', 'Hindi', 'Marathi'],
      education: 'MBBS, MD (Gynecology) - BJ Medical College, Pune',
      achievements: ['Delivered over 3000 healthy babies', 'Pioneer in painless labor techniques in western region'],
    ...
    },
    {
      ...
      offersVirtual: true,
      bio: 'Dr. Saxena specializes in advanced cataract surgery, refractive surgery (LASIK), and glaucoma management.',
      languages: ['English', 'Hindi'],
      education: 'MBBS, MS (Ophthalmology) - Maulana Azad Medical College, Delhi',
      achievements: ['Performed 5000+ successful cataract surgeries', 'Awarded best paper presentation at AIOS conference'],
      availableDays: [1, 2, 4, 5]
    },
    {
      id: '18',
      ...
      offersVirtual: true,
      bio: 'Dr. Kapoor provides empathetic care for anxiety disorders, depression, stress management, and behavioral counseling.',
      languages: ['English', 'Hindi', 'Punjabi'],
      education: 'MBBS, MD (Psychiatry) - PGIMER Chandigarh',
      achievements: ['Organized multiple workplace mental health workshops', 'Regular columnist for mental health awareness in leading daily'],
      availableDays: [1, 2, 4]
    },
    {
      id: '19',
      ...
      offersVirtual: true,
      bio: 'Dr. Malhotra specializes in holistic Ayurveda, treatment of lifestyle disorders, and Panchakarma therapies.',
      languages: ['English', 'Hindi', 'Sanskrit'],
      education: 'BAMS, MD (Ayurveda) - BHU Varanasi',
      achievements: ['Lifetime Achievement Award in Ayurvedic Medicine', 'Pioneered integrated wellness retreats'],
    ...
    },
    {
      ...
      offersVirtual: false,
      bio: 'Dr. Sinha specializes in cosmetic dentistry, dental implants, root canal treatments, and pediatric dentistry.',
      languages: ['English', 'Hindi'],
      education: 'BDS, MDS (Conservative Dentistry) - MAIDS Delhi',
      achievements: ['Best Paper Presentation award in ISPRD', 'Certified Implantologist'],
